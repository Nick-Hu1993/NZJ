...
function addJoin_trace() {
		...
		if($("#code").val() == '' || $("#ename").val() == '' || $("#eTime").val() == '' || $("#ephone").val() == '' || $("#eaddress").val() == '' || $("#econtent").val() == ''|| $("#duration").val() == '' || $("#cost").val() == ''|| $("#aname").val() == '' || $("#aphone").val() == ''|| $("#time").val() == '' || $("#salary").val() == '') {
			alert("请完善信息！");
...
//				}
		...
		$.ajax({
		type: "post",
		url: mainUrl + "getPactListByStatus",
		dataType: "json",
		async: false,
		cache: false,
		data: {
...
//		};
		...
		tr.append("<td class='query_pro'>" + listCode + "</td>" 
