...
public class VUserId implements java.io.Serializable {
	...
	/** minimal constructor */
	public VUserId(Long id, Long phone, Long clock, Integer rank, Integer ack,
			Long did, String username, String company, String contact,
			Long telephone, Long dphone, String address, Integer support) {
		this.id = id;
		this.phone = phone;
		this.clock = clock;
		this.rank = rank;
	...
	/** full constructor */
	public VUserId(Long id, Long phone, Long clock, String time, Integer rank,
			Integer ack, Long did, String username, String company,
